...
impl QuantizedTensor {
    ...
    pub fn matvec_batch_into(&self, inputs: &[&[f32]], out: &mut [f32]) {
        ...
        match self.ggml_type {
            ...
            GgmlType::Q5_0 => matvec_q5_0_batch_scalar(data, self.rows, self.cols, inputs, out),
            GgmlType::Q5_1 => matvec_q5_1_batch_scalar(data, self.rows, self.cols, inputs, out),
...
mod tests {
    ...
    fn batched_matvec_is_bit_identical_iq4_nl_and_q5_variants() {
        for ty in [GgmlType::IQ4NL, GgmlType::Q5_0, GgmlType::Q5_1] {
